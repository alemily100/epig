...
class GPyTorchTrainer: pass
class ParametricLaplace: pass
...
try:
    ...
    print("Muting Laplace library (not needed for Random Forest)")
ParametricLaplace = None
...
try:
    ...
    GPyTorchTrainer = None
    print("Muting GPyTorch (not needed for Random Forest)")
